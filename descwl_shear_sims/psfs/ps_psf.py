...
def make_ps_psf(*, rng, dim, pixel_scale=SCALE, variation_factor=1, model = 'Moffat'):
    """
...
class PowerSpectrumPSF(object):
    ...
    def __init__(self, *,
                 ...
                 median_seeing=0.8, force_psf_width = None):
        self._rng = rng
        ...
        self.force_psf_width = force_psf_width
    ...
    def _get_atm(self, x, y):
        ...
        if self.force_psf_width is None:
            psf = galsim.Moffat(
                beta=2.5,
                fwhm=fwhm
            ).shear(
...
class PowerSpectrumPSF_Gauss(object):
    """Produce a spatially varying Gaussain PSF according to the power spectrum
    given by Heymans et al. (2012).
    ...
    def _get_atm(self, x, y):
        ...
        if self.shear_psf:
            psf_g1 = g1 + self._g1_mean
            psf_g2 = g2 + self._g2_mean
        else:
            psf_g1 = 0
            psf_g2 = 0
